...
/*QUERY 2: WHO ARE THE TWO PLAYERS WHO CLASHED SEVERAL TIMES İN 2019?*/
...
/*QUERY 5: RETURN THE NAME AND 2019 RANK POINTS OF (COUPLE) PLAYERS WHO PLAYED AND WON TOGETHER 
...
/*QUERY 6: IN THE TOURNEY WITH THE HIGHEST NUMBER OF MINUTES PLAYED, IN 2018 AND 2019, 
...
/*QUERY 8: WHAT ARE THE NAMES OF THE PLAYERS WHO CLASHED IN 1VS1 AND WON TOGETHER İN 2VS2 (IN 2019)?*/
...
/*QUERY 9: WHO ARE THE PLAYERS WHO WERE BORN ON 22ND OF APRİL 1996 AND WON A MATCH WHILE PLAYING WITH 
...
where winner_age<loser_age and winner_id =any(select player_id
              from atp_players as b
              where birth_date='19960422')
